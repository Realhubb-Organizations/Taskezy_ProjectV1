  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-between overflow-x-hidden relative">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[600px] pointer-events-none overflow-hidden opacity-40 z-0">
        <div className="absolute -top-40 left-10 w-[500px] h-[500px] rounded-full bg-brand-200/20 blur-[120px]" />
        <div className="absolute -top-30 right-10 w-[400px] h-[400px] rounded-full bg-brand-100/30 blur-[100px]" />
      </div>

      {/* Header */}
      <header className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 py-4 flex items-center justify-between border-b border-slate-200/80 bg-white/40 backdrop-blur-md">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/checkout"
            className="text-sm font-semibold bg-brand-700 hover:bg-brand-600 text-white px-4 py-2 rounded-lg transition-all shadow-md shadow-brand-700/10"
          >
            Configure Plan
          </Link>
        </div>
      ...
      <main className="relative z-10 flex-grow max-w-7xl mx-auto px-6 sm:px-8 py-20 flex flex-col items-center justify-center text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-brand-200 bg-brand-50 text-xs text-brand-700 font-bold mb-8 backdrop-blur-md">
          <Zap className="h-3.5 w-3.5 text-brand-500" />
          <span>Next-Generation Real Estate Operations</span>
        </div>

        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-brand-700 max-w-4xl leading-tight mb-6">
          The Business Operating System for <span className="bg-clip-text text-transparent bg-gradient-to-r from-brand-700 via-brand-600 to-brand-500">Real Estate Enterprise</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-20">
          <Link
            href="/checkout"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-brand-700 to-brand-600 hover:from-brand-650 hover:to-brand-500 text-white font-semibold px-8 py-4 rounded-xl transition-all shadow-lg shadow-brand-700/15 group"
          >
          ...
          <Link
            href="/auth/login"
            className="inline-flex items-center gap-2 border border-slate-250 bg-white hover:bg-slate-50 text-slate-700 font-semibold px-8 py-4 rounded-xl transition-all shadow-sm"
          >
