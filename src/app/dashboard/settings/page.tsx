...
export default function SettingsPage() {
  ...
  const [integrations, setIntegrations] = useState([
    { name: "Meta Ads", status: "Active (4 Accounts)", description: "Capture leads from Facebook & Instagram advertising campaigns" },
    { name: "Google Ads", status: "Active", description: "Capture leads from Google Search & Display campaigns" },
