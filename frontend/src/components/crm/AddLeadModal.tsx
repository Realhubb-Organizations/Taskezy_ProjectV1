...
export default function AddLeadModal({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-start sm:items-center justify-center p-0 sm:p-4">
      ...
      {/* Modal Box — full-screen on mobile, centered dialog from sm: up */}
      <div className="relative bg-white rounded-none sm:rounded-3xl shadow-xl w-full max-w-lg min-h-screen sm:min-h-0 overflow-hidden border-0 sm:border border-slate-200 z-55 animate-fade-in">
        {/* Header */}
