...
export default function FinanceDashboardPage() {
  const { invoices, reimbursements, leads, isDataLoading } = useApp();
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="bg-white p-3.5 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            ...
            {isDataLoading ? <LineSkeleton width={80} height={18} /> : <p className="text-base font-black text-slate-800">₹{totalInvoiced.toLocaleString()}</p>}
        ...
        <div className="bg-white p-3.5 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            ...
            {isDataLoading ? <LineSkeleton width={60} height={18} /> : <p className="text-base font-black text-amber-600">{pendingClaimsCount} claims</p>}
        ...
        <div className="bg-white p-3.5 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            ...
            {isDataLoading ? <LineSkeleton width={70} height={18} /> : <p className="text-base font-black text-brand-700">{pendingFinanceReview} bookings</p>}
